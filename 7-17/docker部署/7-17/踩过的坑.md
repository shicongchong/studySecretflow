...
```
docker运行的命令:docker run --rm my-sf-app python /app/7-17/demo.py
```

![image-20260717190659041](.assets/image-20260717190659041.png)

```
docker system df -v | grep -E "secretflow|my_sf_app"
```

![image-20260717192055470](.assets/image-20260717192055470.png)